...
export default function Nav() {
  ...
  return (<nav className="navbar text-neutral-content bg-neutral justify-between">
    <div className="flex grow flex-row justify-start">
      {navData.length > 0 &&
        (<div className="dropdown flex-none lg:hidden">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-neutral rounded-box">
            {navData.map((item) => {
